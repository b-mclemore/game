...
public:
    ...
    void setAtlasGlyphDims(int width, int height);
    std::pair<int, int> getAtlasGlyphDims();

    void setRenderGlyphDims(int width, int height);
    std::pair<int, int> getRenderGlyphDims();
